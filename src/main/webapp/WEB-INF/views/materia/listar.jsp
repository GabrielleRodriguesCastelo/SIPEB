                ...
                <div class="col-lg-12">
					...
					<div class="row">
									...
									<table class="table table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td>${materia.nome }</td>
												<td>${materia.sigla }</td>
												<td><a href="./alterar?id=${materia.id}" type="button" class="btn btn-warning btn-xs">Alterar</a></td>
												<td><button type="button" onClick="excluir('${materia.id}')"  class="btn btn-danger btn-xs"> Remover </button>  </td>
											</tr>
											</c:forEach>
									</tbody>
								</table>
								...
								<c:if test="${empty materias}">
									<div  class="alert alert-danger"  role="alert" ><p>Nenhuma matéria cadastrada</p></div>
								</c:if>
